...
function buildCSSInjectionCode(_a) {
    return __awaiter(this, arguments, void 0, function* ({ buildOptions, cssToInject, injectCode, injectCodeFunction, injectionCodeFormat = 'iife', styleId, useStrictCSP, }) {
