...
<template>
  <div class="voces-widget" :class="`voces-theme-${props.theme}`">
    ...
    <form v-if="!hideForm" class="voces-form" @submit.prevent="handleSubmit">
      <div
      ...
      >
        ...
        >
          ...
          ></span>
          <span v-if="field.is_required" class="voces-required">*</span>
        </label>
        ...
        <p v-if="validationErrors[field.name]" class="voces-validation-error">
      ...
      <div class="voces-field voces-altcha-wrapper">
        ...
        <p v-if="validationErrors.altcha" class="voces-validation-error">
